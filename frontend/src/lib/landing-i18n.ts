...
export const landingT = {
  en: {
    ...
    forgotH1: 'Forgot your password?',
    forgotSub: 'Enter your email and we will send you a link to reset your password.',
    forgotBtn: 'Send reset link →',
    forgotBtnLoading: 'Sending…',
    forgotSentH1: 'Check your email',
    forgotSentBody: (email: string) => `If ${email} has an account on GoldTrader, you will receive a reset link within the next few minutes.`,
    forgotSentSpam: "Can't find it? Check your spam folder.",
    forgotBackLogin: '← Back to login',
    forgotCreateAccount: 'Create free account',
    forgotInvalidLink: 'Invalid link',
    forgotInvalidBody: 'This recovery link is not valid.',
    forgotRequestNew: 'Request a new link →',
    forgotEmailPlaceholder: 'your@email.com',
    forgotFooter: 'No credit card · No real risk · 100% simulator',

    // Auth — Reset password
    resetH1: 'New password',
    resetSub: 'Choose a secure password of at least 8 characters.',
    resetLabelNew: 'New password',
    resetLabelConfirm: 'Confirm password',
    resetBtn: 'Update password →',
    resetBtnLoading: 'Updating…',
    resetDoneH1: 'Password updated',
    resetDoneSub: 'Redirecting to login in a few seconds…',
    resetDoneBtn: 'Go to login →',
    resetErrorMismatch: 'Passwords do not match.',
    resetErrorLength: 'Minimum 8 characters.',
    resetErrorExpired: 'The link is invalid or has expired.',
  },
  es: {
    ...
    // Auth — Forgot password
    forgotH1: '¿Olvidaste tu contraseña?',
    forgotSub: 'Introduce tu email y te enviaremos un enlace para restablecer tu contraseña.',
    forgotBtn: 'Enviar enlace de recuperación →',
    forgotBtnLoading: 'Enviando…',
    forgotSentH1: 'Revisa tu email',
    forgotSentBody: (email: string) => `Si ${email} tiene una cuenta en GoldTrader, recibirás un enlace para restablecer tu contraseña en los próximos minutos.`,
    forgotSentSpam: '¿No lo ves? Revisa la carpeta de spam.',
    forgotBackLogin: '← Volver al login',
    forgotCreateAccount: 'Crear cuenta gratis',
    forgotInvalidLink: 'Enlace inválido',
    forgotInvalidBody: 'Este enlace de recuperación no es válido.',
    forgotRequestNew: 'Solicitar nuevo enlace →',
    forgotEmailPlaceholder: 'tu@email.com',
    forgotFooter: 'Sin tarjeta de crédito · Sin riesgo real · 100% simulador',

    // Auth — Reset password
    resetH1: 'Nueva contraseña',
    resetSub: 'Elige una contraseña segura de al menos 8 caracteres.',
    resetLabelNew: 'Nueva contraseña',
    resetLabelConfirm: 'Confirmar contraseña',
    resetBtn: 'Actualizar contraseña →',
    resetBtnLoading: 'Actualizando…',
    resetDoneH1: 'Contraseña actualizada',
    resetDoneSub: 'Redirigiendo al login en unos segundos…',
    resetDoneBtn: 'Ir al login →',
    resetErrorMismatch: 'Las contraseñas no coinciden.',
    resetErrorLength: 'Mínimo 8 caracteres.',
    resetErrorExpired: 'El enlace es inválido o ha expirado.',
  },
} as const;
